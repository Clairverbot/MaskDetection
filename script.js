...
var model = undefined;
const model_url =
  "https://raw.githubusercontent.com/Clairverbot/wakanda/main/model.json";
//Call load function
...
async function detectTFMOBILE(imgToPredict) {
  ...
  let predictions = await model.predict(tf4d_);

  let predVal = predictions.argMax(1).dataSync()[0];
  document.getElementById("prediction").style.color =
    predVal == 0 ? "green" : "red";
  document.getElementById("prediction").innerHTML =
    predVal == 0 ? "Masked" : "No mask";
